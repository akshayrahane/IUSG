...
function hide_divs() {
	...
	<%! 
	Vector<String>  vvuser= new Vector<String>();
	%>
...
<%
               ...
               StringTokenizer strSentence = new StringTokenizer(data, ".", false);
				...
				<%
				    ...
				    int dataid=searchForm.getDataindexid();
					
					String url=searchForm.getUrls();
					String title=searchForm.getTitle();
					String description=searchForm.getTitledata();
					...
					//
					searchForm.setDataindexid(dataid);
					//
					searchForm.setUrls(url);
					//
					searchForm.setRecordscount(count);
					//
					searchForm.setSno(sno);
					//
					searchForm.setVcount(vcount);
					//
					searchForm.setTitle(title);
					//
					searchForm.setDatadescription(description);
					//
					searchForm.setUser(user);
					
				   SearchDAOImpl pdao=new SearchDAOImpl();
					  boolean flag=pdao.addurls(searchForm);
