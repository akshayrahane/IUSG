        ...
        throws IOException
    {
        ...
        for(int l = 0; l < height; l++)
        {
            ...
            for(int k1 = 0; k1 < width; k1++)
            {
                ...
                boolean flag = l1 >>> 24 < 128 || (l1 & 0xffffff) == transparentRgbForced;
                if(flag)
                    if(i < 0)
                    {
                        i = k;
        ...
        GIFEncode(super.out, width, height, _$6316, (byte)0, i, byte0, abyte0, abyte1, abyte2);
    }
...
label0:
    ...
    private boolean _$6316;
    int width;
    int height;
    int rgbPixels[][];
    IntHashtable colorHash;
    public int transparentRgbForced;
    int Width;
    int Height;
    boolean Interlace;
    int curx;
